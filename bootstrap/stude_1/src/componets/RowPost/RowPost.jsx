              ...
              return (
                ...
                >
                  {props.islarge ? (
                    <>
                      <img
                        ...
                        src={`${imageUrl + obj.poster_path  || obj.trailer_url}`}
                      />
                    </>
                  ) : (
                    <>
                      <img
                        ...
                        src={
                          obj.backdrop_path
                            ? `${imageUrl2 + obj.backdrop_path || obj.trailer_url}`
                  ...
                  <div className="content pt-16">
                      ...
                      <div className="ml-4">
                        <StarRatings
                          rating={(obj.vote_average / 2) || (obj.rating / 2.0 )}
                          starRatedColor="red"
                          numberOfStars={5}
                          name="rating"
                ...
                {/*content*/}
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-neutral-800 outline-none focus:outline-none">
                    ...
                    {urlId ? (
                      ...
                      <img src={`${imageUrl + moviePopupInfo.backdrop_path || moviePopupInfo.trailer_url}`} />
                    )}
                    ...
                    {/*body*/}
                      <div className="relative p-4 sm:p-6 flex-auto">
                        ...
                        <p className="my-4 sm:my-7 text-neutral-400 text-xs md:text-lg leading-relaxed line-clamp-4 sm:line-clamp-none">
                          {moviePopupInfo.overview || moviePopupInfo.description}
                        </p>
                        <div className="bg-neutral-700 h-[0.15rem]"></div>
                      </div>
                    {/*footer*/}
                      ...
                      {/*More Info*/}
                        <div className="relative p-2 py-5 sm:p-6 flex-auto">
                          <h1 className="flex -mt-4 text-neutral-400 text-sm leading-relaxed">
                            ...
                            <div className="ml-2">
                              <StarRatings
                                rating={(moviePopupInfo.vote_average / 2) || (moviePopupInfo.rating / 2.0)}
                                starRatedColor="red"
                                numberOfStars={5}
                                name="rating"
                                starDimension="1rem"
                          ...
                          <h1 className="flex text-neutral-400 text-sm leading-relaxed">
                            Language :
                            <p className="text-white ml-2 font-medium">
                              {moviePopupInfo.original_language || "En"}
                            </p>
                          </h1>
